...
(Heavy metals are defined as those metals and metalloids which have an atomic number greater than 20 and density 5 g cc− 1 and also have properties of metals.)
```{r}
