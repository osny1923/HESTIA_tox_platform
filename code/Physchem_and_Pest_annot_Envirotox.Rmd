...
#   Envirotox_no_physchem <- readxl::read_xlsx(path = "../data/Envirotox_2023-01-10/envirotox_DB_20230110081208.xlsx", sheet = "substance", col_names = T, col_types = c("skip", "guess", rep("text", times = 2), rep("skip", times = 19))) %>%
...
# Writing an outut that will generate Physchem data for the EnviroTox dataset, the records that are missing.
